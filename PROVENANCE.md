...
| v2.26 | 2026-07-26 | Codex | GPT-5 / Codex Desktop | @jonathanwxh-cell | Completed the open combat-audio consequence pass: release-frame charged-heavy weight, three received-damage tiers, one-shot projectile closest passes, non-consuming stamina denial, latched arena-ward contact, and a terminal grade stamp; retained the 45-cue manifest, startup graph, simulation, difficulty, rendering, and save-v7 contracts, with expanded real-browser acceptance |
