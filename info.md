...
- Current package: `gracefell@2.11.1`
- Gameplay release: `v2.11.1`
...
[`docs/releases/v2.11.1.md`](docs/releases/v2.11.1.md) for the current victory-score and result
pacing fix, [`docs/releases/v2.11.md`](docs/releases/v2.11.md) for the character-readability
release, and [`docs/releases/v2.10.md`](docs/releases/v2.10.md) for the difficulty-integrity record.
