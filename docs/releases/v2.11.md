...
| Accessibility follow-up | Pending publication |
| GitHub release | Pending final evidence publication |
...
(`a528153a2a051d256f06e9f3fcc20a941cb63ea4`). It was fast-forwarded to the exact merge
`846c8a80923afaa1c36d600f412583ff3fd60a7b`, built as `gracefell@2.11.0`, and restarted through
the user-level `gracefell.service`.

Deployment acceptance:

- remote `git rev-parse HEAD`: `846c8a80923afaa1c36d600f412583ff3fd60a7b`;
- remote worktree: clean `main...origin/main`;
- service: active, Node process listening on `127.0.0.1:8491`;
- local service `/health`: `{"ok":true,"app":"gracefell"}`;
- public `/health`: HTTP 200 with the same body;
- public home: HTTP 200, serving `assets/index-BWug0dGA.js`;
- complete public Playwright gate: PASS, zero errors.
